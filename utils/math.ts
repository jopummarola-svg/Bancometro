...
export const evaluateFeasibility = (data: UserData): FeasibilityResult => {
  const rate = BENCHMARKS_2026.FIXED_RATE;
  ...
  const totalSubsistenceNeeded = BENCHMARKS_2026.MIN_SUBSISTENCE_BASE + (data.dependents * BENCHMARKS_2026.MIN_SUBSISTENCE_PER_DEPENDENT);
