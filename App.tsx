  ...
  <div className="mb-6">
    ...
    <div className="relative group">
      <input
        ...
        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all pr-12 group-hover:border-slate-300"
      />
      {suffix && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <section className="lg:col-span-8 space-y-8">
              ...
              <p className="text-center text-xs font-semibold text-slate-400 py-2">
                Versione 2.0.9 - App di proprietà di Mario SORICE (C)2026-2028 - Tutti i diritti riservati.
              </p>
