        ...
        {view === 'simulator' ? (
          ...
          <div className="max-w-4xl mx-auto py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                { name: 'Mario SORICE', phone: '3933364925', role: 'Senior Credit Analyst' },
                { name: 'Daniela RUGGIERO', phone: '3496753212', role: 'Mortgage Specialist' }
              ].map((contact, i) => (
                <div key={i} className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/60 border border-slate-100 flex flex-col items-center text-center group hover:border-indigo-500 transition-all">
                  <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mb-6 border-4 border-white shadow-inner group-hover:bg-indigo-50 transition-colors">
                    <User className="w-10 h-10 text-slate-300 group-hover:text-indigo-500" />
                  </div>
                  ...
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    <a 
                      ...
                      className="flex items-center justify-center gap-3 bg-indigo-500 hover:bg-indigo-600 text-white font-black py-4 rounded-2xl transition-all shadow-lg shadow-indigo-100"
                    >
            ...
            <div className="mt-16 p-8 bg-indigo-50 rounded-3xl border border-indigo-100 text-center">
              <p className="text-indigo-800 font-bold text-sm">
                I nostri consulenti sono disponibili dal Lunedì al Venerdì, dalle 09:00 alle 18:00.
              </p>
            </div>
          </div>
        )}
